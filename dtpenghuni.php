    ...
    <div class="container">
        <div class="card text-bg-light text-center mt-5">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a class="btn btn-warning" href="edit_penghuni.php?id=<?= $row['id']; ?>">
                                        ...
                                        <a class="btn btn-danger" href="hapus_penghuni.php?id=<?= $row['id']; ?>">
            ...
            <div class="card-footer">
                <a href="tambah_penghuni.php" class="btn btn-primary">Tambah Penghuni</a>
            </div>
        </div>
    </div>
</body>
